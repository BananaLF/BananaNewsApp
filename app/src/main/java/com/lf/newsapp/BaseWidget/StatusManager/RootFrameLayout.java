...
public class RootFrameLayout extends FrameLayout {
    ...
    private void showHideViewById(int id) {
        for(int i = 0; i < layoutSparseArray.size(); i++) {
            ...
            if(key == id) {
                ...
                if(mStatusLayoutManager.getOnShowHideViewListener() != null) mStatusLayoutManager.getOnShowHideViewListener().onShowView(valueView, key);
            } else {
                if(valueView.getVisibility() != View.GONE) {
                    valueView.setVisibility(View.GONE);
                    if(mStatusLayoutManager.getOnShowHideViewListener() != null) mStatusLayoutManager.getOnShowHideViewListener().onHideView(valueView, key);
                }
            }
        }
    }
    ...
    public void retryLoad(View view, int id) {
        ...
        if(retryView == null || mStatusLayoutManager.getOnRetryListener() == null) return;
